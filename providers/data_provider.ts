...
const without = (resource: string, fields_: string[]) => fields[resource].split(" ").filter(field => !fields_.includes(field))
...
const dataProvider: DataProvider = {
    ...
    async update(resource, params) {
        ...
        const input = Object.keys(params.data).filter(key => editFields[resource].includes(key)).reduce((obj, key) => {
